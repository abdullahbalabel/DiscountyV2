  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#fff8f6' }}>
      <View style={{ padding: 16, gap: 24 }}>
        ...
        {/* Header */}
        <Text style={{ fontFamily: 'Cairo_700Bold', fontSize: 30, color: '#231917' }}>
          Component Library
        </Text>

        {/* ── Typography ── */}
        <Section title="Typography">
          <Text style={{ fontFamily: 'Cairo_700Bold', fontSize: 36, color: '#231917' }}>
            Heading 4xl
          </Text>
          <Text style={{ fontFamily: 'Cairo_700Bold', fontSize: 24, color: '#231917' }}>
            Heading 2xl
          </Text>
          <Text style={{ fontFamily: 'Cairo_700Bold', fontSize: 18, color: '#231917' }}>
            Heading lg
          </Text>
        ...
        <Section title="Cards">
          <View style={{
            ...
            <Text style={{ fontFamily: 'Cairo_700Bold', fontSize: 16, color: '#231917' }}>
              Simple Card
            </Text>
